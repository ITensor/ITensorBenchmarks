...
class ElectronKSite
    ...
    ElectronKSite(int n, Args const& args = Args::global())
        {
        *this = ElectronKSite({args,"SiteNumber=",n});
        }
...
using HubbardKSite = ElectronKSite;

using HubbardK = BasicSiteSet<HubbardKSite>;
